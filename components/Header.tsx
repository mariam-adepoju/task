    ...
    return (
        <header className="flex items-center justify-between">
            <div className="flex flex-col">
                ...
                <Image src="https://mintcdn.com/safedep/SBr4leJ2Q_jWmTGH/images/full-logo-for-light-theme.png?fit=max&auto=format&n=SBr4leJ2Q_jWmTGH&q=85&s=c5133b0c57a88228719710fb4c94ff90" alt="Logo" width={145} height={32} priority />
            </div>
